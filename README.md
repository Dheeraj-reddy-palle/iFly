...
To prevent automated data collection from halting when free-tier API quotas are exhausted, iFly uses a cascading failover strategy. 
If the primary Amadeus API limit is reached, it seamlessly falls back to AviationStack, and finally to a strictly capped Synthetic provider. This ensures continuous, fresh data flow for model training without data gaps, a crucial feature for production ML systems.
...
| Metric | Value |
|--------|-------|
| **Test R²** | 0.621 (62.1% variance explained) |
| **Test MAE** | €158.84 |
| **Routes Tracked** | 307 |
| **Airlines Tracked** | 175 |
| **Data Points** | 93,996 |
